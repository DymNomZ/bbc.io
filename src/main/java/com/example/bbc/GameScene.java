...
public class GameScene extends Scene implements Runnable {
    ...
    static FXMLLoader fxmlLoader = new FXMLLoader(IOGame.class.getResource("game-panel.fxml"));
...
//    }
    ...
    public GameScene() {
        ...
        this.setOnKeyPressed(key_input);
        this.setOnKeyReleased(key_input);
        this.setOnMousePressed(mouse_handler);
        this.setOnMouseReleased(mouse_handler);
    }
