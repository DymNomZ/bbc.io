...
public abstract class PanelEntity {
    ...
    public int getTileXPosition(){
        return x / (GameScene.TILE_SIZE);
    }
    public int getTileYPosition(){
        return y / (GameScene.TILE_SIZE);
    }
    ...
    public boolean checkIfTouching(MapEntity d1){
        ...
        int dx = d1.x - GameScene.TILE_SIZE;
        int dy = d1.y - GameScene.TILE_SIZE;
        int dx2 = d1.x + (GameScene.TILE_SIZE * 2);
        int dy2 = d1.y + (GameScene.TILE_SIZE * 2);

        int x1 = x - GameScene.TILE_SIZE;
        int y1 = y - GameScene.TILE_SIZE;
        int x2 = x + (GameScene.TILE_SIZE * 2);
        int y2 = y + (GameScene.TILE_SIZE) * 2;
    ...
    public Point getTilePosition() {
        return new Point(x / GameScene.TILE_SIZE, y / GameScene.TILE_SIZE);
    }
}
